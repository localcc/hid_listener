...
class HidListenerBindingsLinux {
  ...
  HidListenerBindingsLinux(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  HidListenerBindingsLinux.fromLookup(
...
final class LinuxKeyboardEvent extends ffi.Struct {
  @ffi.Int32()
  external int eventType;

  @ffi.Uint32()
  external int unicodeScalarValues;
...
abstract class LinuxKeyboardEventType {
  static const int LKE_KeyUp = 0;
  static const int LKE_KeyDown = 1;
}
