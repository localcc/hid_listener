...
#ifndef HIDLISTENER_SWIFT_H
#define HIDLISTENER_SWIFT_H
...
enum MacOsKeyboardEventType : NSInteger;
@class NSString;
...
@property (nonatomic, copy) NSString * _Nonnull charactersIgnoringModifiers;
@property (nonatomic) NSInteger keyCode;
@property (nonatomic) NSInteger modifiers;
@property (nonatomic) BOOL isMedia;
@property (nonatomic) enum MacOsMediaEventType mediaEventType;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, MacOsKeyboardEventType, closed) {
  MacOsKeyboardEventTypeKeyDown = 0,
  MacOsKeyboardEventTypeKeyUp = 1,
};

typedef SWIFT_ENUM(NSInteger, MacOsMediaEventType, closed) {
  MacOsMediaEventTypePlay = 0,
  MacOsMediaEventTypePrevious = 1,
  MacOsMediaEventTypeNext = 2,
  MacOsMediaEventTypeRewind = 3,
  MacOsMediaEventTypeFast = 4,
  MacOsMediaEventTypeMute = 5,
  MacOsMediaEventTypeBrightnessUp = 6,
  MacOsMediaEventTypeBrightnessDown = 7,
  MacOsMediaEventTypeVolumeUp = 8,
  MacOsMediaEventTypeVolumeDown = 9,
};
